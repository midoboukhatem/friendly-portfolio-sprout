...
const Blog = () => {
  ...
  return (
    <section id="blog" className="min-h-screen w-full bg-white dark:bg-black relative flex flex-col">
      {/* particles */}
      ...
      <div className="relative z-10 flex flex-col items-center justify-center flex-grow mt-32">
        ...
        >
          <div className="relative flex items-center justify-center">
            <div className="relative p-10 rounded-full !bg-[#e6ba38] dark:!bg-[#e6ba38] border border-white/10 dark:border-black/10">
              ...
              >
                {/* icon color override */}
                <FileText className="h-24 w-24 !text-[#2c2c2c]" />
              </motion.div>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          >
            I'll be sharing my thoughts, experiences, and insights about Salesforce, development, and more. Stay tuned!
          </motion.p>
        </motion.div>
      </div>
      <SocialButtons />
